        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-4">
            <div className="relative group bg-stone-100 rounded-2xl overflow-hidden">
              <img 
                src="https://images.unsplash.com/photo-1621447509374-f20384462152?q=80&w=600&auto=format" 
            ...
            <img 
              src="https://images.unsplash.com/photo-1599488611731-0158b282c967?q=80&w=600&auto=format" 
              alt="Raw Spices" 
          ...
          <div className="pt-12">
            <img 
              src="https://images.unsplash.com/photo-1566478989037-eec170784d0b?q=80&w=600&auto=format" 
              alt="Gourmet Chips" 
