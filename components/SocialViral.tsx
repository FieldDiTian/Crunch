      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="aspect-[9/16] relative rounded-3xl overflow-hidden shadow-2xl group bg-stone-800">
            <img src="/assets/social_viral_1.webp" className="w-full h-full object-cover" alt="Viral Snacks" referrerPolicy="no-referrer" />
          ...
          <div className="aspect-[9/16] relative rounded-3xl overflow-hidden shadow-2xl mt-8 bg-stone-800">
            <img src="/assets/social_viral_2.webp" className="w-full h-full object-cover" alt="Food Trend" referrerPolicy="no-referrer" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent p-6 flex flex-col justify-end">
          ...
          <div className="aspect-[9/16] relative rounded-3xl overflow-hidden shadow-2xl bg-stone-800">
            <img src="/assets/social_viral_3.webp" className="w-full h-full object-cover" alt="Aesthetic Food" referrerPolicy="no-referrer" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent p-6 flex flex-col justify-end">
          ...
          <div className="aspect-[9/16] relative rounded-3xl overflow-hidden shadow-2xl mt-8 bg-stone-800">
            <img src="/assets/social_viral_4.webp" className="w-full h-full object-cover" alt="Tasty Crisps" referrerPolicy="no-referrer" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent p-6 flex flex-col justify-end">
